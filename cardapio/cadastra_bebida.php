...
<body>
    ...
    <section class="services" id="services" style="background-color: #fcf9f4; color:#111">
        <h1 align="center" style="color:#3e733b;">Adicionar Bebida</h1>
        <form method="post" action="processa_cadastra_bebida.php" enctype="multipart/form-data" onsubmit="return validarEntrada();">
            <div class="topo">

                <div class="esquerda" style="margin-right:40px;">
                    Status da bebida: <br><select name="status">
                ...
                <div class="esquerda">
                    Tipo de bebida: <br><select name="bebida">
            ...
            <div class="cardapio-container">
                ...
                <div class='cardapio-item2'>
                    ...
                    <div class='cardapio-title' style='color:#111;'>
                        Nome:<input type="text" name="nome" placeholder="Ex: Coca-cola" required>
                    </div>
                    <div class="input-container">

                        <div class='cardapio-title'>
                        Preço:<input type="number" name="preco" placeholder="Ex: 5" step="0.01" required>
                        </div>

                        <div class='cardapio-title'>
                            Descrição:<input type="text" name="descricao" id="descricao" placeholder="Ex: 600 ml" required>
                        </div>
