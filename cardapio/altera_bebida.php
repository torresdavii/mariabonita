...
<body style="background-color: black;">
    ...
    <section class="about bebidas" id="about bebidas" style="background-color:black;">
        <h1 style="margin-top: 40px;">Selecione a bebida e altere</h1><br>
        <div class="container">
        ...
        <div id="content1" class="content active">
            ...
            <div class="cardapio-container">
                ...
                while ($registro = mysqli_fetch_row($resultado_consulta)) {
                    ...
                    echo "  <a href='altera_dados_bebida.php?codigo=$registro[2]'>
                                    <button class='cardapio-altera' style='background-color:black;'>
                                        <p>Alterar</p>
                                    </button>
                                </a>";
                    echo "</div>";
