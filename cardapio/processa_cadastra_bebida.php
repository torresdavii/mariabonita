...
$sql_cadastrar = "INSERT INTO bebidas (
                                            condicao,
											nome, 
                                            preco,
											descricao, 
...
if ($sql_resultado_cadastrar == true) {
	...
	echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    title: 'Sucesso!',
                    text: 'Bebida adicionada com sucesso.',
                    icon: 'success',
                ...
                setTimeout(function() {
                    window.location.href = 'cadastra_bebida.php';
	...
	echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    title: 'Erro!',
                    text: 'Erro ao adicionar bebida: " . $conectar->error . "',
                    icon: 'error',
                    showConfirmButton: false,
                    timer: 1500,
                    customClass: {
