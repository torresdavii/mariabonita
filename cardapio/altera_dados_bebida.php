...
<body>
    ...
    <h1 align="center" style="color:#3e733b;">Alterar Bebida</h1>
        ...
        ?>
        <form method="post" id="formAltera" action="processa_altera_bebida.php" onsubmit="return validarEntrada();">
            ...
            <div class="topo">
                ...
                <div class="esquerda" style="margin-right:40px;">
                    Status da bebida: <br><select name="status">
                        <option value="enabled"
                            <?php
                            if ($registro[4] == "enabled") {
                                echo "selected";
                            }
                            ?>> Disponível </option>
                        <option value="disabled"
                            <?php
                            if ($registro[4] == "disabled") {
                                echo "selected";
                            }
                            ?>> Indisponível </option>
                ...
                <div class="esquerda">
                    Dia da Semana: <br><select name="bebida">
                        <option value="refrigerante"
                            <?php
                            if ($registro[2] == "refrigerante") {
                                echo "selected";
                            }
                            ?>> Refrigerante </option>
                        <option value="suco"
            ...
            <div class="cardapio-container">
                ...
                <div class='cardapio-item2'>
                    ...
                    <div class='cardapio-title' style='color:#111;'>
                        Nome da bebida:<input type="text" name="nome" required
